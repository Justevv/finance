...
public class EmailVerificationKafkaProducerConfig {
    ...
    @Value("${spring.kafka.producer.topics.email-verification}")
    private String topic;

    @Bean
    public ProducerFactory<String, EmailVerificationResponseDto> emailVerificationProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, EmailVerificationResponseDto> emailVerificationKafkaTemplate() {
        KafkaTemplate<String, EmailVerificationResponseDto> kafkaTemplate = new KafkaTemplate<>(
                emailVerificationProducerFactory());
