...
@Slf4j
public class EmailVerificationSpringDataRepositoryImp implements EmailVerificationRepository {

    private final EmailVerificationSpringDataRepository repository;
    private final EntityMapper<UserEntity, UserModel> userMapper;
    private final EntityMapper<EmailVerificationEntity, VerificationModel> mapper;
